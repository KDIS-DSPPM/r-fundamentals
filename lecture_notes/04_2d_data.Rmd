...
fullName <- paste("Jae Yeon", "Kim")
```

```{r}
# So use this instead
substr(x = fullName, # a character vector
       start = 1, # the first element 
       stop = 3) # the last element 
...
fullName
fullName2 <- "Jae Yeon Kim "
fullName3 <- "Jae Yeon kim"
```
...
```{r}
# return only the rows where x == 5
df[df$x == 5, ]
